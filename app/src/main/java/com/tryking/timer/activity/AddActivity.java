...
//        SPUtils.put(AddActivity.this, "endTimes", "0600,0800");
        ...
        if (starts.length == 1 && starts[0] == "") {
            ...
            Logger.e(haveThingStartInts.toString());
            Logger.e(haveThingEndInts.toString());
            Logger.e(nothingStartInts.toString());
            Logger.e(nothingEndInts.toString());
        }
        tvHint.setText("您可以选择的时间段有:" + s);
    }
            ...
            if (haveThingStartInts.size() == 0) {
                ...
                for (int i = 0; i < nothingStartInts.size(); i++) {
                    if (start >= nothingStartInts.get(i) && end <= nothingEndInts.get(i)) {
                        Logger.e(haveThingStartInts.toString() + "start;end:" + haveThingEndInts.toString());
